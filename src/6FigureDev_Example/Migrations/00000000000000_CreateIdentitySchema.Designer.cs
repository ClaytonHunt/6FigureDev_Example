...
using _6FigureDev_Example.Models;

namespace _6FigureDev_Example.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("_6FigureDev_Example.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("_6FigureDev_Example.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
